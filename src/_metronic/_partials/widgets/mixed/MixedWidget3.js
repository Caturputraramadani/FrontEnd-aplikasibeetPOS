          ...
          <div className="card-spacer" style={{ marginTop: "-3rem" }}>
            <div className="row m-0">
              <div className="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                ...
                <a
                  href="#"
                  className="text-warning font-weight-bold font-size-h3"
                >
                  {t("grossSales")}
                </a>
                <p>
                  ...
                  (<NumberFormat value={todaySales} displayType={'text'} thousandSeparator={true} prefix={currency} />) 
                </p>
              </div>
              <div className="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                ...
                <a
                  href="#"
                  className="text-primary font-weight-bold font-size-h3 mt-2"
                >
                  {t("grossProfit")}
                </a>
                <p>
