        ...
        <div className="card-header border-0 bg-white py-5">
          ...
          <div className="card-toolbar">
            <Dropdown className="dropdown-inline" drop="down" alignRight>
              <Dropdown.Toggle
                className="btn btn-transparent-primary btn-sm font-weight-bolder dropdown-toggle px-5"
                variant="warning"
            ...
            >
              <ExportExcel
                className="btn btn-transparent-primary btn-sm font-weight-bolder px-5"
