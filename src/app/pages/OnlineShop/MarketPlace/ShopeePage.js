...
export default function ShopeePage() {
  ...
  const handleCancel = async () => {
    ...
    try {
      await axios.delete(`${API_URL}/api/v1/request-integration-online-shop/delete-by-outlet?business_id=${userInfo.business_id}&outlet_id=${dataOutlet.id}&online_shop_name=shopee`)
  ...
  return (
    <div>
      ...
      <ConfirmModal
        ...
        body={t('areYouSureCancelingApplyingIntegrationShopee')}
        buttonColor="danger"
